...
def hero():
    ...
    while(y):
        clear()
        system(banner)
        print(f"{red}Contact me on telegram @VIK200102")
...
if(expirydate>today):
    ...
    if (now>Third and now<Thirdend):
        ...
        print(" admin on telegram @VIK200102 ")
    ...
    print(" on telegram ----@VIK200102 for activating")
    ...
    while(True):
        ...
        print(f"If It Does'nt Open Contact Me On Telegram {yellow}@VIK200102")
        print(f"{neon}*---------*----------*-------------*----------*")
        print(f"{red}*---------*----------*-------------*----------*")
        print("payhere--- UPI or paypal : ")
        print(f"{yellow}UPI1 : 9606807597@paytm")
        print("Paypal2 : Vik20010219@gmail.com")
        ...
        if(bhai==code or bhai==test or bhai==code1 or bhai==code2):
            ...
            print(f"{neon}On Telegram {red}@VIK200102")
            print("wait.... starting....")
            time.sleep(20)
            period=rava
            hero()
